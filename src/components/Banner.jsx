...
function Banner() {
    ...
    return (
        <>
            <div id="Home" className='main-font h-full bg-[url(./assets/img/banner0.jpg)] bg-bg-color bg-no-repeat bg-left-bottom bg-cover lg:px-52 px-10 lg:py-20 max-sm:pt-20 md:pt-20 gap-5 flex lg:flex-col flex-col justify-between'>

                <div className='h-full lg:py-40 flex-col justify-center lg:items-start items-center text-white mt-14'>
                    <h1 data-aos='fade-right' className='text-[3.7rem] font-bold mb-4 leading-normal text-white'>Your HEALTH is <br /> VITAL to us  </h1>

                    <p data-aos='fade-left'
                        className='text-button max-w-screen-lg text-xl lg:text-justify'> ...One stop shop for healthy living </p>
                </div>
            ...
            <div id="Home" className='main-font max-md:flex-col-reverse h-screen bg-[url(./assets/img/banner.jpg)] bg-left-bottom bg-no-repeat lg:px-20 px-10 lg:py-0 max-sm:pt-20 md:pt-20 gap-20 flex lg:flex-row flex-row justify-between  items-center'>

                <div data-aos='fade-up' src="" className='bg-[url(./assets/img/3.jpg)] border-2 h-80 w-96 bg-no-repeat bg-cover bg-center p-1 border-button py-0 max-sm:mt-8' alt="" />
