                      ...
                      <div className="item" key={item.id}>
                        ...
                        <div className="details">
                          ...
                          {index === 0 ? (
                            ...
                            <Link
                              to={
                                "MainLayout/Aerobics/Beginner/GymRoom/RoomTwo"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Aerobics/Beginner/GymRoom/RoomThree"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Aerobics/Beginner/GymRoom/RoomFour"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Aerobics/Beginner/GymRoom/RoomFive"
                              }
                              smooth={true}
                            >
                              view all ....
