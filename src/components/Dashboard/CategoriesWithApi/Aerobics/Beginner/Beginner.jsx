                      ...
                      <div className="item" key={item.id}>
                        ...
                        <div className="details">
                          {index === 0 ? (
                            <Link
                              to={
                                "/dashboard/aerobic/advanced/AerobicsBeRoomOne"
                              }
                              smooth={true}
                            >
                            ...
                            <Link
                              to={
                                "/dashboard/aerobic/advanced/AerobicsBeRoomThree"
                              }
                              smooth={true}
                            >
                              <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            ...
                            <Link
                              to={
                                "/dashboard/aerobic/advanced/AerobicsBeRoomFour"
                              }
                              smooth={true}
                            >
                              <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            ...
                            <Link
                              to={
                                "/dashboard/aerobic/advanced/AerobicsBeRoomFIve"
                              }
                              smooth={true}
                            >
                              <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
