                            ...
                            {data?.map((item, index) =>{
                                ...
                                <div className="item" key={item.id}>
                                    ...
                                    <div className="details">
                                        ...
                                        {
                                            index === 0 ? <Link to={'MainLayout/Aerobics/Intermediate/GymRoom/RoomOne'} smooth={true} > 
                                            view all ....
                                         </Link>
                                            :(index === 1? <Link to={'MainLayout/Aerobics/Intermediate/GymRoom/RoomTwo'} smooth={true} > 
                                                                view all ....
                                                            </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Aerobics/Intermediate/GymRoom/RoomThree'} smooth={true} > 
                                                                    view all ....
                                                                </Link>  
                                            :  (index === 2 ? <Link to={'MainLayout/Aerobics/Intermediate/GymRoom/RoomFour'} smooth={true} > 
                                                                    view all ....
                                                                </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Aerobics/Intermediate/GymRoom/RoomFive'} smooth={true} > 
                                                                    view all ....
                                                                </Link>: null))))
                                        }
                                    </div>
