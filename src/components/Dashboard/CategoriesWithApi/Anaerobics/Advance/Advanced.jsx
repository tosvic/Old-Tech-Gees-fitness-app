                ...
                return (
                  <div className="item" key={item.id}>
                    <div className="details">
                      {index === 0 ? (
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsAdRoomOne"}
                          smooth={true}
                        >
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsAdRoomTwo"}
                          smooth={true}
                        >
                          <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsAdRoomThree"}
                          smooth={true}
                        >
                          <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsAdRoomFour"}
                          smooth={true}
                        >
                          <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsAdRoomFive"}
                          smooth={true}
                        >
                          <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
