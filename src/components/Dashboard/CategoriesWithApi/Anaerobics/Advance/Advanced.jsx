                            ...
                            {data?.map((item, index) =>{
                                ...
                                <div className="item" key={item.id}>
                                    ...
                                    <div className="details">
                                        ...
                                        {
                                            index === 0 ? <Link to={'MainLayout/Anaerobics/Advance/GymRoom/RoomOne'} smooth={true} > 
                                            view all ....
                                         </Link>
                                            :(index === 1? <Link to={'MainLayout/Anaerobics/Advance/GymRoom/RoomTwo'} smooth={true} > 
                                                                view all ....
                                                            </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Advance/GymRoom/RoomThree'} smooth={true} > 
                                                                    view all ....
                                                                </Link>  
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Advance/GymRoom/RoomFour'} smooth={true} > 
                                                                    view all ....
                                                                </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Advance/GymRoom/RoomFive'} smooth={true} > 
                                                                    view all ....
                                                                </Link>: null))))
                                        }
                                    </div>
