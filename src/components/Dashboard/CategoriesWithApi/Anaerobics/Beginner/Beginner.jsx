                ...
                return (
                  <div className="item" key={item.id}>
                    <div className="details">
                      {index === 0 ? (
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsBeRoomOne"}
                          smooth={true}
                        >
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsBeRoomTwo"}
                          smooth={true}
                        >
                          <div className="p-6 my-3  max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={
                            "/dashboard/aerobic/advanced/AnaerobicsBeRoomThree"
                          }
                          smooth={true}
                        >
                          <div className="p-6 my-3  max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsBeRoomFour"}
                          smooth={true}
                        >
                          <div className="p-6 my-3  max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/aerobic/advanced/AnaerobicsBeRoomFive"}
                          smooth={true}
                        >
