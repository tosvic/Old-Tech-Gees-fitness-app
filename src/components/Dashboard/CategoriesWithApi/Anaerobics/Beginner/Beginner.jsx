                            ...
                            {data?.map((item, index) =>{
                                ...
                                <div className="item" key={item.id}>
                                    ...
                                    <div className="details">
                                        ...
                                        {
                                            index === 0 ? <Link to={'MainLayout/Anaerobics/Beginner/GymRoom/RoomOne'} smooth={true} > 
                                            view all ....
                                         </Link>
                                            :(index === 1? <Link to={'MainLayout/Anaerobics/Beginner/GymRoom/RoomTwo'} smooth={true} > 
                                                                view all ....
                                                            </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Beginner/GymRoom/RoomThree'} smooth={true} > 
                                                                    view all ....
                                                                </Link>  
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Beginner/GymRoom/RoomFour'} smooth={true} > 
                                                                    view all ....
                                                                </Link>
                                            :  (index === 2 ? <Link to={'MainLayout/Anaerobics/Beginner/GymRoom/RoomFive'} smooth={true} > 
                                                                    view all ....
                                                                </Link>: null))))
                                        }
                                    </div>
