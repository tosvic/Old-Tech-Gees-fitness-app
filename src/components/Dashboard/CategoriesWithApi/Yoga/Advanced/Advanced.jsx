                ...
                return (
                  <div className="item" key={item.id}>
                    <div className="details">
                      {index === 0 ? (
                        <Link to="/dashboard/yoga/advanced/YogaAdRoomOne" smooth={true}>
                        ...
                        <Link to="/dashboard/yoga/advanced/YogaAdRoomTwo" smooth={true}>
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                              <h4>{data[index].name}</h4>
                            </div>
                        ...
                        <Link to="/dashboard/yoga/advanced/YogaAdRoomThree" smooth={true}>
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                              <h4>{data[index].name}</h4>
                            </div>
                        ...
                        <Link to= "/dashboard/yoga/advanced/YogaAdRoomFour" smooth={true}>
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                              <h4>{data[index].name}</h4>
                            </div>
                        ...
                        <Link to= "/dashboard/yoga/advanced/YogaAdRoomFive" smooth={true}>
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                              <h4>{data[index].name}</h4>
                            </div>
