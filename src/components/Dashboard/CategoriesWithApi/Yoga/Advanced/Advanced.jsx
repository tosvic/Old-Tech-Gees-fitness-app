                    ...
                    return (
                      <div className="item" key={item.id}>
                        ...
                        <div className="details">
                          ...
                          {index === 0 ? (
                            <Link to={"YogaGymRoomOne"} smooth={true}>
                              view all ....
                            </Link>
                          ) : index === 1 ? (
                            <Link to={"GymRoomTwo"} smooth={true}>
                              view all ....
                            </Link>
                          ) : index === 2 ? (
                            <Link to={"GymRoomThree"} smooth={true}>
                              view all ....
                            </Link>
                          ) : index === 2 ? (
                            <Link to={"GymRoomFour"} smooth={true}>
                              view all ....
                            </Link>
                          ) : index === 2 ? (
                            <Link to={"GymRoomFive"} smooth={true}>
                              view all ....
                            </Link>
                          ) : null}
                        </div>
