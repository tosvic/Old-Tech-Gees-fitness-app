                    ...
                    return (
                      <div className="item" key={item.id}>
                        ...
                        <div className="details">
                          ...
                          {index === 0 ? (
                            <Link to={"YogaIntOne"} smooth={true}>
                              view all ....
                            </Link>
                          ) : index === 1 ? (
                            <Link
                              to={
                                "MainLayout/Yoga/Intermediate/GymRoom/RoomTwo"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Yoga/Intermediate/GymRoom/RoomThree"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Yoga/Intermediate/GymRoom/RoomFour"
                              }
                              smooth={true}
                            >
                              view all ....
                            ...
                            <Link
                              to={
                                "MainLayout/Yoga/Intermediate/GymRoom/RoomFive"
                              }
                              smooth={true}
                            >
                              view all ....
