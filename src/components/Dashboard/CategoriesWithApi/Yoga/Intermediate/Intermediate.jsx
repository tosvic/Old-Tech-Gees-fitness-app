              ...
              if (index < 5) {
                return (
                  <div className="item" key={item.id}>
                    <div className="">
                      {index === 0 ? (
                        <Link to="/dashboard/yoga/intermediate/YogaInRoomOne" smooth={true}>
                        ...
                        <Link
                          to={"/dashboard/yoga/intermediate/YogaInRoomTwo"}
                          smooth={true}
                        >
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/yoga/intermediate/YogaInRoomThree"}
                          smooth={true}
                        >
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                            <div className="py-1 font-medium text-black">
                        ...
                        <Link
                          to={"/dashboard/yoga/intermediate/YogaInRoomFour"}
                          smooth={true}
                        >
                          {" "}
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
                        ...
                        <Link
                          to={"/dashboard/yoga/intermediate/YogaInRoomFive"}
                          smooth={true}
                        >
                          {" "}
                          <div className="p-6 my-3 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
...
export default YogaIntermediate;
