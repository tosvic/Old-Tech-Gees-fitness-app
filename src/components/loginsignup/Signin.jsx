...
import "./Singin.css";
import logo from './images/logoAlone.jpg'
  ...
  return (
    <div className="loginFormContainer bg-bg-color">
      <div className="Texts text-xl font-medium text-black">
        <h3 className="productName text-center text-color-logo-txt font-extrabold p-6"> <img src={logo} alt="" /> Vitality </h3>
        <h2 className="heroText text-xl  text-black text-center font-bold"> Sign in to your existing account </h2>
      </div>
      <form action="submit" onSubmit={formSubmitHandler}>
        ...
        <div className="form-submit-area items-center">
          {/* {showMessage.length > 0 && (
            ...
            <div>
                <p className="message-bar text-xl font-medium text-center text-black  "> Already have an acccount? login </p>
                {/* <p className="message-bar text-xl font-medium text-center text-black  ">  Already have an acccount? login </p> */}
            </div>
          <button type="submit" className=" bg-button hover:bg-button-300...  logBtn" > Signin  </button>
        </div>
      </form>
      {/* <div>
